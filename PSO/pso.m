...
% line([locations(path(p),1) locations(path(p+1), 1)], [locations(path(p), 2) locations(path(p+1), 2)], 'Color','m','LineWidth',2, 'LineStyle','-') 
% end 
% hold on 
%                
%  for i2 = 1:nVar
%   plot(locations(i2, 1),locations(i2, 2),'o','LineWidth',1,...
%                'MarkerEdgeColor','k',...
%                'MarkerFaceColor','w',...
%                'MarkerSize',8); 
%            xlabel('X in m')
%            ylabel('Y in m')
%      text(locations(i2, 1)+2, locations(i2, 2), num2str(i2),'FontSize',10); 
%  hold on
%  
%  plot(locations(path(1), 1),locations(path(1), 2),'o','LineWidth',1,...
%                'MarkerEdgeColor','k',...
%                'MarkerFaceColor','g',...
%                'MarkerSize',10); 
%            xlabel('X in m')
